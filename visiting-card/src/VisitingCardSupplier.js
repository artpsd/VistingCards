  ...
  return (
    ...
    <Box sx={{ display: 'flex', flex: 1, flexDirection: 'row' }}>
      ...
      <Box sx={{ zIndex: 1, width: '70%', backgroundColor: leftBackgroundColor, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', }}>     
        <Box sx={{ width:'100%', display: 'flex', justifyContent:'right', alignItems: 'center', marginBottom: '0.1rem', backgroundColor: '#414141'  , paddingBlock: '8px', paddingLeft: '16px'}}>
          <Typography variant="body1" sx={{ fontSize:'12px', color: textColor, fontFamily: 'DM Sans' }}>
            {phone}
          </Typography>
          <Box sx={{ width: 23, height: 23, borderRadius: '50%', boxShadow: '0 3px 8px rgba(0,0,0,0.5)', backgroundColor: circleBackgroundColor, display: 'flex', justifyContent: 'center', alignItems: 'center',  color: iconColor, marginLeft: '20px' }}>
            <PhoneIcon fontSize="extrasmall" />
          </Box>
        </Box>
        <Box sx={{  width:'100%', display: 'flex', justifyContent:'right', alignItems: 'center', marginBottom: '0.1rem', backgroundColor: '#414141'  , paddingBlock: '8px', }}>
          <Typography variant="body1" sx={{ fontSize:'12px', color: textColor, fontFamily: 'DM Sans' }}>
            {personName}
          </Typography>
          <Box sx={{ width: 23, height: 23, borderRadius: '50%', boxShadow: '0 3px 8px rgba(0,0,0,0.5)', backgroundColor: circleBackgroundColor, display: 'flex', justifyContent: 'center', alignItems: 'center', color: iconColor, marginLeft: '20px'  }}>
        ...
        <Box sx={{  width:'100%', display: 'flex', justifyContent:'right', alignItems: 'center', marginBottom: '0.1rem', backgroundColor: '#414141'  , paddingBlock: '8px', marginRight: '16px' }}>
          <Typography variant="body1" sx={{ fontSize:'12px', color: textColor, fontFamily: 'DM Sans' }}>
            {email}
          </Typography>
          <Box sx={{ width: 23, height: 23, borderRadius: '50%', boxShadow: '0 3px 8px rgba(0,0,0,0.5)', backgroundColor: circleBackgroundColor, display: 'flex', justifyContent: 'center', alignItems: 'center', color: iconColor , marginLeft: '20px'}}>
        ...
        <Box sx={{ width:'100%', display: 'flex', justifyContent:'right', alignItems: 'flex-start', marginBottom: '0.1rem', backgroundColor: '#414141' , paddingBlock: '8px', marginRight: '32px'}}>
        ...
        <Box sx={{ width:'100%', display: 'flex', alignItems: 'center', justifyContent:'right', marginBottom: '0.1rem' , backgroundColor: '#414141'  , paddingBlock: '8px',  marginRight: '48px'}}>
          <Typography variant="body1" sx={{ fontSize:'12px', color: textColor, fontFamily: 'DM Sans' }}>
            {website}
          </Typography>
          <Box sx={{ width: 23, height: 23, borderRadius: '50%', boxShadow: '0 3px 8px rgba(0,0,0,0.5)', backgroundColor: circleBackgroundColor, display: 'flex', justifyContent: 'center', alignItems: 'center',  color: iconColor, marginLeft: '20px' }}>
        ...
        sx={{
          ...
          clipPath: 'polygon(20.5% 0%, 69.0% 0%, 75.8% 100%, .5% 100%)',
          transform: 'rotate(102deg) translate(0%, -50%)',
          transformOrigin: 'top left',
          zIndex: -2,
        }}
